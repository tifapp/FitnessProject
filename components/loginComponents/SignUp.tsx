...
} from 'aws-amplify-react-native/src/Auth/common/default-sign-up-fields';
import TEST_ID from 'aws-amplify-react-native/src/AmplifyTestIDs';
import { ISignUpField } from 'aws-amplify-react-native/types';
...
export default class SignUp extends AuthPiece<ISignUpProps, ISignUpState> {
	...
	constructor(props: ISignUpProps) {
		...
		const { usernameAttributes = 'email' } = this.props;
