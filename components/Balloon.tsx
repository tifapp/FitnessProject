...
// Custom Balloon SVG component
export const BalloonIcon = ({ width = 48, height = 48, color = AppStyles.colorOpacity10 }: {width: number; height: number; color: string;}) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 100 100">
      {/* Main balloon path - using the exact path data provided */}
      <Path
