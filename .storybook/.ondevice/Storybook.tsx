...
import AviationThemeMeta, { Basic as AviationTheme } from "../components/AviationTheme/AviationTheme.stories";
...
const stories = [
  {
    name: AviationThemeMeta.title,
    component: AviationTheme,
    args: AviationThemeMeta.args
  },
