        ...
        try {
          ...
          if (record.dynamodb.OldImage.isParent.N == 1) {
            while (true) {
              ...
              if (results.data.postsByParentId.nextToken == null) break;
            }
          }

          callback(null, "successfully deleted likes and replies");
        } catch (e) {
          console.warn('Error deleting likes and replies: ', e);
          callback(Error(e));
        }
      })();
    }
